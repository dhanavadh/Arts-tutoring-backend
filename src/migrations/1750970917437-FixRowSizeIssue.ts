  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    try {
      await queryRunner.query(
        `ALTER TABLE quiz_questions MODIFY COLUMN question TEXT`,
      );
    } catch (error) {
    ...
    try {
      await queryRunner.query(
        `ALTER TABLE quiz_questions MODIFY COLUMN correct_answer TEXT`,
      );
    } catch (error) {
    ...
    try {
      await queryRunner.query(
        `ALTER TABLE quiz_questions MODIFY COLUMN correct_answer_explanation TEXT`,
      );
    } catch (error) {
      console.log(
        'Correct answer explanation column already TEXT or does not exist',
      );
    }
    ...
    try {
      ...
      if (tableExists) {
        ...
        if (hasColumn) {
          await queryRunner.query(
            `ALTER TABLE teachers DROP COLUMN qualifications`,
          );
        }
      }
    } catch (error) {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    try {
      ...
      if (tableExists) {
        ...
        if (!hasColumn) {
          await queryRunner.query(
            `ALTER TABLE teachers ADD COLUMN qualifications JSON NULL`,
          );
        }
      }
    } catch (error) {
